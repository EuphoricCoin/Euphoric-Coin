...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "EuphoricCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"EuphoricCointools.timehub.com", "dnsseed.EuphoricCointools.timehub.com"},
    {"xurious.com", "dnsseed.EPC.xurious.com"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"EuphoricCointools.timehub.com", "testnet-seed.EuphoricCointools.timehub.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. EuphoricCoin is probably already running."), addrBind.ToString().c_str());
        else
